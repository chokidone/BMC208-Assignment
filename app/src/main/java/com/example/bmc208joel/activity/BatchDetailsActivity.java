...
import com.example.bmc208joel.adapter.CustomVaccinationListViewAdapter;
...
public class BatchDetailsActivity extends AppCompatActivity {
    ...
    //Other variables
    private ArrayList<VaccinationClass> vaccinationClassArrayList; //store list of vaccination obj related to current batch
    ...
    private BatchClass selectedBatchClass; //to store current batch obj
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedBatchClass = (BatchClass) getIntent().getSerializableExtra("batchClass");
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value,
                        ...
                        for (QueryDocumentSnapshot doc : value) {
                            BatchClass batchClass = doc.toObject(BatchClass.class);
        ...
        vaccinationListenerRegistration = db.collection("Vaccinations")
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value,
                        ...
                        for (QueryDocumentSnapshot doc : value) {
                            VaccinationClass vaccinationClass = doc.toObject(VaccinationClass.class);
