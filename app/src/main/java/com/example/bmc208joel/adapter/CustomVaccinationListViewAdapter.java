...
import com.example.bmc208joel.activity.BatchDetailsActivity;
import com.example.bmc208joel.objects.BatchClass;
import com.example.bmc208joel.objects.UserClass;
import com.example.bmc208joel.objects.VaccinationClass;
...
public class CustomVaccinationListViewAdapter extends ArrayAdapter<VaccinationClass> {
    ...
    public CustomVaccinationListViewAdapter(@NonNull Context context, @NonNull ArrayList<VaccinationClass> vaccinationClassArrayList) {
        super(context, R.layout.custom_vaccination_listview, vaccinationClassArrayList);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        VaccinationClass selectedVaccinationClass = getItem(position);
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.custom_vaccination_listview, parent, false);
        }
    ...
    private void setManageMode(VaccinationClass selectedVaccinationClass) {
    ...
    private void setPopup(VaccinationClass selectedVaccinationClass, ViewGroup parent) {
    ...
    private void getPopupData(VaccinationClass selectedVaccinationClass) {
        db.collection("Users")
        ...
        db.collection("Batches")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                BatchClass selectedBatchClass = document.toObject(BatchClass.class);
